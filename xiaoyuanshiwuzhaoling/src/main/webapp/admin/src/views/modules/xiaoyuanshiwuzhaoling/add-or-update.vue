    ...
    <div class="addEdit-block">
        <el-form
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="失物编号" prop="xiaoyuanshiwuzhaolingUuidNumber">
                       <el-input v-model="ruleForm.xiaoyuanshiwuzhaolingUuidNumber"
                                 placeholder="失物编号" clearable  :readonly="ro.xiaoyuanshiwuzhaolingUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物品名称" prop="xiaoyuanshiwuzhaolingName">
                       <el-input v-model="ruleForm.xiaoyuanshiwuzhaolingName"
                                 placeholder="物品名称" clearable  :readonly="ro.xiaoyuanshiwuzhaolingName"></el-input>
                   </el-form-item>
                   <div v-else>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiaoyuanshiwuzhaolingPhoto" label="物品图片" prop="xiaoyuanshiwuzhaolingPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.xiaoyuanshiwuzhaolingPhoto?ruleForm.xiaoyuanshiwuzhaolingPhoto:''"
                            @change="xiaoyuanshiwuzhaolingPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="拾遗时间" prop="xiaoyuanshiwuzhaolingTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:ss:mm"
                                v-model="ruleForm.xiaoyuanshiwuzhaolingTime"
                                type="datetime"
                                placeholder="拾遗时间">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiaoyuanshiwuzhaolingTime" label="拾遗时间" prop="xiaoyuanshiwuzhaolingTime">
                            <span v-html="ruleForm.xiaoyuanshiwuzhaolingTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="拾遗地址" prop="xiaoyuanshiwuzhaolingDizhi">
                       <el-input v-model="ruleForm.xiaoyuanshiwuzhaolingDizhi"
                                 placeholder="拾遗地址" clearable  :readonly="ro.xiaoyuanshiwuzhaolingDizhi"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="xiaoyuanshiwuzhaolingContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xiaoyuanshiwuzhaolingContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiaoyuanshiwuzhaolingContent" label="详情" prop="xiaoyuanshiwuzhaolingContent">
                            <span v-html="ruleForm.xiaoyuanshiwuzhaolingContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    xiaoyuanshiwuzhaolingUuidNumber: false,
                ...
                ruleForm: {
                    xiaoyuanshiwuzhaolingUuidNumber: new Date().getTime(),
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='xiaoyuanshiwuzhaolingUuidNumber'){
                          this.ruleForm.xiaoyuanshiwuzhaolingUuidNumber = obj[o];
                          this.ro.xiaoyuanshiwuzhaolingUuidNumber = true;
                          continue;
                      }
                      if(o=='xiaoyuanshiwuzhaolingName'){
                          this.ruleForm.xiaoyuanshiwuzhaolingName = obj[o];
                          this.ro.xiaoyuanshiwuzhaolingName = true;
                          continue;
                      }
                      ...
                      if(o=='xiaoyuanshiwuzhaolingPhoto'){
                          this.ruleForm.xiaoyuanshiwuzhaolingPhoto = obj[o];
                          this.ro.xiaoyuanshiwuzhaolingPhoto = true;
                          continue;
                      }
                      if(o=='xiaoyuanshiwuzhaolingTime'){
                          this.ruleForm.xiaoyuanshiwuzhaolingTime = obj[o];
                          this.ro.xiaoyuanshiwuzhaolingTime = true;
                          continue;
                      }
                      if(o=='xiaoyuanshiwuzhaolingDizhi'){
                          this.ruleForm.xiaoyuanshiwuzhaolingDizhi = obj[o];
                          this.ro.xiaoyuanshiwuzhaolingDizhi = true;
                          continue;
                      }
                      if(o=='xiaoyuanshiwuzhaolingContent'){
                          this.ruleForm.xiaoyuanshiwuzhaolingContent = obj[o];
                          this.ro.xiaoyuanshiwuzhaolingContent = true;
                          continue;
                      }
                    }
                }
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xiaoyuanshiwuzhaoling/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xiaoyuanshiwuzhaolingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            xiaoyuanshiwuzhaolingPhotoUploadChange(fileUrls){
                this.ruleForm.xiaoyuanshiwuzhaolingPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
