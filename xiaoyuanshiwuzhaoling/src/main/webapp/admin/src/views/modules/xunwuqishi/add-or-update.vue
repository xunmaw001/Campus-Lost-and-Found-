        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xunwuqishiPhoto" label="物品图片" prop="xunwuqishiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.xunwuqishiPhoto?ruleForm.xunwuqishiPhoto:''"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="丢失时间" prop="xunwuqishiTime">
                        <el-date-picker
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="xunwuqishiContent">
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='xunwuqishiName'){
                          this.ruleForm.xunwuqishiName = obj[o];
                          this.ro.xunwuqishiName = true;
                          continue;
                      }
                      ...
                      if(o=='xunwuqishiPhoto'){
                          this.ruleForm.xunwuqishiPhoto = obj[o];
                          this.ro.xunwuqishiPhoto = true;
                          continue;
                      }
                      if(o=='xunwuqishiTime'){
                          this.ruleForm.xunwuqishiTime = obj[o];
                          this.ro.xunwuqishiTime = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='xunwuqishiDizhi'){
                          this.ruleForm.xunwuqishiDizhi = obj[o];
                          this.ro.xunwuqishiDizhi = true;
                          continue;
                      }
                      if(o=='xunwuqishiContent'){
                          this.ruleForm.xunwuqishiContent = obj[o];
                          this.ro.xunwuqishiContent = true;
                          continue;
                      }
                    }
                }
